...
<title>User Management Curd oprations</title>
<script
...
<script type="text/javascript">
	...
	app.controller('myappcontroller', function($scope, $http) {
		...
		function getUserDetails() {
			$http({
				method : 'GET',
				url : 'http://localhost:8080/ANGULAR/userdetails_two'
		...
		$scope.processUser = function() {
			$http({
				method : 'POST',
				url : 'http://localhost:8080/ANGULAR/user',
		...
		$scope.deleteUser = function(user) {
			$http({
				method : 'DELETE',
				url : 'http://localhost:8080/ANGULAR/deleteuser',
